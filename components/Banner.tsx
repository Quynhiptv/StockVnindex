      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          <div className="max-w-4xl text-center lg:text-left flex flex-col items-center lg:items-start">
            {/* Real-time Data Pill at the top */}
            <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 backdrop-blur-md border border-white/10 text-emerald-400 text-[10px] md:text-xs font-black uppercase tracking-[0.2em] mb-8 shadow-xl self-center lg:self-start">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
              ...
              <div className="flex flex-col">
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[0.95] drop-shadow-2xl uppercase tracking-tighter mb-4">
